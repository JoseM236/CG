...
void renderiza() {
    ...
    // Aqui você pode adicionar a renderização dos outros planetas
}

void estadoExecucao() {
    glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT);
    glLoadIdentity();
    gluLookAt(0, 0, 500, 0, 0, 0, 0, 1, 0);  // Câmera fixa
    renderiza();
    glutSwapBuffers();
}
...
void defBase() {
    ...
    // Aqui você pode configurar as texturas e faces dos outros planetas
}
